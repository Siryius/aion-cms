...
# ----------------------------
#
# This file contains settings for spending vote points for category 2 of rewards
# 
#  */
...
class Spend
{
	...
	function __construct()
	{
		...
		$Con = mysql_connect(Gamedb_host,Gamedb_user,Gamedb_pass);
		mysql_select_db(Gamedb);
                                    $res = mysql_query("SELECT itemid,description FROM voterewards2 WHERE id='{$Reward}'");
                                    $Row = mysql_fetch_array($res);
                mysql_query("INSERT INTO inventory VALUES('$uniqueid','{$Row['itemid']}','{$Row['description']}','null','$Character','0','0','1','0','0','{$Row['itemid']}','0','0','0')");
