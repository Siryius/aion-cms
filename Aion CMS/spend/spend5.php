...
# ----------------------------
#
# This file contains settings for spending vote points for category 5 of rewards
# 
#  */
...
class Spend
{
	...
	function __construct()
	{
		...
		$Con = mysql_connect(Gamedb_host,Gamedb_user,Gamedb_pass);
		mysql_select_db(Gamedb);
                                    $res = mysql_query("SELECT itemid,description FROM voterewards5 WHERE id='{$Reward}'");
