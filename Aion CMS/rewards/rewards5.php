...
# ----------------------------
#
# This file contains settings for redeeming vote points (category 5 of rewards)
# 
#  */
...
function GetRewardData()
	{
		...
		$RewardInfo = "{";
		$res = mysql_query("SELECT id,realm,name,description,points FROM voterewards5");
		while($Row = mysql_fetch_array($res))
