...
# ----------------------------
#
# This file contains settings for redeeming vote points (category 2 of rewards)
# 
#  */
...
function GetRewardData()
	{
		...
		$RewardInfo = "{";
		$res = mysql_query("SELECT id,realm,name,description,points FROM voterewards2");
		while($Row = mysql_fetch_array($res))
