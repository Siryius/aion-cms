...
# ----------------------------
#
# This file contains settings for redeeming vote points (category 8 of rewards)
# 
#  */
...
function GetRewardData()
	{
		...
		$RewardInfo = "{";
		$res = mysql_query("SELECT id,realm,name,description,points FROM voterewards8");
		while($Row = mysql_fetch_array($res))
